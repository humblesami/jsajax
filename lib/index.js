class AjaxClient {
    ...
    on_api_failed(endpoint, stage, message, raw_result) {
        console.log('failed to serve '+endpoint+' at '+stage+' with '+message);
        console.log('\n Full result', raw_result);
    }
    on_api_complete() { }
    ...
    set_header_tokens(updated_headers = {}, token_attrs = {}) {
    ...
    async fetch_request(
        ...
        try {
            ...
            fetch_options.headers = this.set_header_tokens();
            ...
            return fetch(server_endpoint, fetch_options).then(api_response => {
                ...
                try{
                    ...
                    console.log('Failed to process response => '+ er1);
                }
                this.after_request_handling(processed_result, '200', server_endpoint);
                ...
                try{
                    ...
                    console.log(er_not_accessible, 'Failed to process error => '+ er2);
                }
    ...
    after_request_handling(api_result, stage, endpoint, message=''){
        try{
            ...
            if(stage == '200'){
                ...
                console.log('Failed to proceed after success => '+er1);
            }
            else{
                console.log(api_result);
                console.log('Failed to proceed after error => '+er1);
            }
        }
        try{
            ...
            console.log('Failed to execute on complete => '+er1);
        }
    }
